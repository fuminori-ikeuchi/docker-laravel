<?php
      // github参照 https://github.com/minoryorg/laravel-resources-lang-ja
...
return [
    ...
    */
    ...
    'between'              => [
        'numeric' => ':attributeには:min〜:max円までの数値を指定してください。',
    ...
    'max'                  => [
        ...
        'string'  => ':attributeには:max文字以下で入力してください。',                        // 変更
    ...
    'min'                  => [
        'numeric' => ':attributeには:min円以上の数を指定してください。',                      // 変更
    ...
    'required'             => ':attributeを入力して下さい。',                              // 変更(は必須です。)
